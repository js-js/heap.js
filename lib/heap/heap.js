...
function Heap(options) {
  ...
  this.registerMap('global', 'object', Map.flags.object);
...
Heap.prototype._allocObject = function _allocObject(map, size, fieldSize) {
  var Object = heap.entities.Object;
  if (!fieldSize)
    fieldSize = 0;
  fieldSize = Math.max(heap.entities.Object.minSize, fieldSize);
...
Heap.prototype.allocObject = function allocObject(size) {
  var Object = heap.entities.Object;
  var res = this._allocObject('object', Object.size(), size);
...
Heap.prototype.allocGlobal = function allocGlobal(size) {
  ...
  var res = this._allocObject('global', Global.size(), size);
