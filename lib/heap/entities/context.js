...
Context.alloc = function alloc(heap) {
  var res = heap.allocTagged('data', 'context', Context.size());
...
Context.prototype.visit = function visit(cb, ptr) {
  if (!ptr)
    ptr = this.ptr();
  Context.super_.prototype.visit.call(this, cb, ptr);
